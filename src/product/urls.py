...
from product.views.product import CreateProductView, ProductList, SearchProduct, ProductCreateApiView
...
urlpatterns = [
    ...
    path('api/create/', ProductCreateApiView.as_view(), name="create-api")
]
